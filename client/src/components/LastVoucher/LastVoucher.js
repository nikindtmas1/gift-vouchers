...
const LastVoucher = () => {
  ...
  const onClick = (e) => {
    ...
    const foundVoucher = vouchers.filter(
      (x) => x.numVoucher === vouchers.length
    );
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].date}
                    ></input>{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].numVoucher}
                    />{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].nameBuyer}
                    />{" "}
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].nameOwn}
                    />{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].nameEmployee}
                    />{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].treatment}
                    />{" "}
                  </div>
                </div>
              </div>
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].count}
                    />{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].price}
                    />{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].validDate}
                    />{" "}
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].typeTransaction}
                    />{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].usedDate}
                    />{" "}
                  </div>
                  <div className="form-group">
                    {" "}
                    ...
                    <input
                      ...
                      defaultValue={searchVoucher[0].email}
                    />{" "}
                  </div>
                </div>
              </div>
