            ...
            <form className='formSearch'>
                ...
                <div className='row'>
                    <div className="col-md-6">
                        <div className="form-group"> <label for="form_name">Date *</label> <input id="form_name" type="text" name="date" className="form-control"  required="required" data-error="Date is required." defaultValue={'ok'} ></input> </div>
